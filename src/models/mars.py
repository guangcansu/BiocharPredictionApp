...
src/models/mars.py
==================
MARS via LinearGAM (pyGAM) — multi-output (11 inputs → 9 outputs).
Requires: pip install pygam
Run: python src/models/mars.py
"""
import sys, os
...
def train():
    ...
    for i in range(y.shape[1]):
        model = LinearGAM().fit(X_train, y_train[:, i])
...
if __name__ == '__main__':
    print("\n=== MARS / LinearGAM Model (Multi-Output) ===")
